	...
	return (
      <div className="book">
	          ...
	          <div className="div-row confRoute"> To: {props.flightData.toAirport} </div>
						<label htmlFor="name" required>Name:</label> <input type="text" id="name" name="user_name"/>
						<label htmlFor="surname" required>Surname:</label> <input type="text" id="surname" name="user_surname"/>
						<label htmlFor="mail" required>E-mail:</label> <input type="email" id="mail" name="user_email"/>
